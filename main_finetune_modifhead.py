...
"""
last version: main_modif_train.py
...
#     def dataset_split(data_loader_train):
#         imgs_list = []
#         annots_list = []
#         for i, (imgs, annots) in enumerate(data_loader_train):
            
#             # print('imgs------------:', imgs)
#             # print('imgs----type--------:', type(imgs))
#             # print('imgs----[0]----type----:', type(imgs.tensors[0]))
#             # print('imgs----[0]--------:',imgs.tensors[0])
#             # print('imgs----size--------:', imgs.size)
#             print('annots----------:', annots)
#             print('annots----type------:', type(annots))
#             print('annots---[0]-------:', annots[0])
#             print('annots---[0]-type------:', type(annots[0]))
            
#             imgs_list.append(imgs.tensors[0])
#             annots_list.append(annots)

#             if i == 0:
#                 break
#         imgs_list_cat = torch.cat(imgs_list, dim =0)  
#         annots_list_cat = torch.cat(annots_list, dim =0)
#         return imgs_list_cat, annots_list_cat
    
#     def _create_dataloader(x, y):
#         """Create a DataLoader from tensors."""
#         dataset = torch.utils.data.TensorDataset(x, y)
#         return torch.utils.data.DataLoader(dataset, batch_sampler=batch_sampler_train,
#                                    collate_fn=utils.collate_fn, num_workers=args.num_workers)
    
#     imgs_list_cat, annots_list_cat = dataset_split(data_loader_train)
#     data_loader_train = _create_dataloader(imgs_list_cat, annots_list_cat)
    
    
    
    ## Note: not applicable 03/28/2025:
    ####### modification: 
...
if __name__ == '__main__':
    ...
    args = parser.parse_args()                                          # Amir 03/28/2025. 
    if args.output_dir:
...
# ## finetune Detr-R50-DC5 on Kitti
